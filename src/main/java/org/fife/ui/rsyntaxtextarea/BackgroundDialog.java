...
class BackgroundDialog extends JDialog implements ActionListener {
    private final JRadioButton colorButton;
    private final JRadioButton imageButton;
    private final JButton colorBrowseButton;
    private final JButton imageBrowseButton;
    private final JButton okButton;
    private final ColorOrImageIcon colorOrImageIcon;
    ...
    BackgroundDialog(Dialog owner) {
        ...
        msg = ResourceBundle.getBundle("org.fife.ui.rtextarea.BackgroundDialog");

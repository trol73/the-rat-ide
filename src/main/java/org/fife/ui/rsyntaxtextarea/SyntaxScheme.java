...
/**
 * The set of colors and styles used by an <code>RSyntaxTextArea</code> to color tokens.<p>
...
public class SyntaxScheme implements Cloneable, TokenTypes {
     ...
     *
     * @param baseFont   The base font to use when creating this scheme.  If
     *                   this is <code>null</code>, then a default monospaced font is used.
     * @param fontStyles Whether bold and italic should be used in the scheme
     *                   (vs. all tokens using a plain font).
     */
    public void restoreDefaults(Font baseFont, boolean fontStyles) {
        ...
        Color literalFloatNumber = new Color(100, 0, 200);
        Color literalHexNumber = new Color(0xff, 0xcc, 0xff);
        Color literalBinNumber = new Color(0xcc, 0xff, 0xcc);
        ...
        styles[LITERAL_NUMBER_FLOAT] = new Style(literalFloatNumber);
        styles[LITERAL_NUMBER_HEXADECIMAL] = new Style(literalHexNumber);
        styles[LITERAL_NUMBER_BINARY] = new Style(literalBinNumber);
        ...
        public void startElement(String uri, String localName, String qName,
            ...
            if ("style".equals(qName)) {
                ...
                if (field.getType() == int.class) {
                    ...
                    if (ulineStr != null) {
                        scheme.styles[index].underline = Boolean.parseBoolean(ulineStr);
                    }

 ...
 * added to org.fife.ui.options.OptionsDialog for an RSyntaxTextArea.
 ...
 * <code>org.fife.ui.options.OptionsDialog</code> to display options appropriate
...
public class RSyntaxTextAreaOptionPanel extends OptionsDialogPanel
    ...
    private final FontSelector mainFontSelector;
    private final JTextField mainBackgroundField;
    private final JButton mainBackgroundButton;
    private BackgroundDialog backgroundDialog;
    private Object background;
    private String bgImageFileName; // null if background is a color.

    private final JPanel syntaxPanel;

    private final JList<String> syntaxList;
    private final DefaultListModel<String> syntaxListModel;
    private final FontSelector fontSelector;
    private final RColorSwatchesButton foregroundButton;
    private final JCheckBox fgCheckBox;
    private final JCheckBox bgCheckBox;
    private final RColorSwatchesButton backgroundButton;

    private final JComboBox<String> sampleCombo;
    private final RSyntaxTextArea sampleArea;
    ...
    public RSyntaxTextAreaOptionPanel() {
        ...
        if (orientation.isLeftToRight()) {
            ...
            springPanel.add(mainFontSelector);
        ...
        // Syntax panel contains all the "syntax highlighting" stuff.
        syntaxPanel = new JPanel(new BorderLayout());
        syntaxPanel.setBorder(new OptionPanelBorder(msg.getString("FontsAndColors")));
        ...
        syntaxListModel.addElement(msg.getString("Style.Literal.Binary"));
        ...
        foregroundButton.addPropertyChangeListener(RColorButton.COLOR_CHANGED_PROPERTY, this);
        temp.add(fgCheckBox);
        ...
        backgroundButton.addPropertyChangeListener(RColorButton.COLOR_CHANGED_PROPERTY, this);
        temp.add(bgCheckBox);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // If the user clicked the "foreground" check box.
            ...
            colorScheme.getStyle(indexToStyle(i)).foreground = selected ? foregroundButton.getColor() : null;
            refreshSyntaxHighlightingSection();
            setDirty(true);
        }
        ...
        // If the user clicked the "background" check box.
            ...
            // Update our color scheme.
            int i = syntaxList.getSelectedIndex();
            colorScheme.getStyle(indexToStyle(i)).background = selected ? backgroundButton.getColor() : null;
            refreshSyntaxHighlightingSection();
            setDirty(true);
        }
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        foregroundButton.setColor(notNull ? style.foreground : getTextAreaForeground());

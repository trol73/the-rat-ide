...
public final class Utilities {
     ...
     */
    //private static final DateFormat LAST_MODIFIED_DATE_FORMAT = new SimpleDateFormat("MM/dd/yyyy hh:mm a");
    private static final DateFormat LAST_MODIFIED_DATE_FORMAT = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");

    /**
     * Should only be accessed on the EDT.
     */
    private static final NumberFormat fileSizeFormat;
     ...
     */
    public static String getFileSizeStringFor(long size, boolean reportInKB) {
        String str;
        if (reportInKB) {
            String suffix = " bytes";
            if (size >= 1024) {

...
public class FileSystemTree extends ToolTipTree implements FileSelector {
    ...
    protected void configurePopupMenuActions() {
        ...
        // item is selected.
        enable = (selectedFile != null && selectedFile.isDirectory()) || (selectedFile == null && root.getFile() != null);
        ...
        pasteAction.setEnabled(enable && Utilities.getClipboardContainsFileList());
    }

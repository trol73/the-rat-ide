...
public interface Actions {
    ...
    class CopyAction extends FileSelectorAction {
        ...
        private final FileSelector chooser;
        ...
        CopyAction(FileSelector chooser) {
            ...
            putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_C, mod));
        }
    ...
    class PasteAction extends FileChooserAction {
        ...
        PasteAction(RTextFileChooser chooser) {
            ...
            putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_V, mod));
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (destDir.isDirectory()) { // Should always be true
                ...
                try {
                    ...
                    List<File> files = (List<File>) contents.getTransferData(accepted);
    ...
    class SystemOpenAction extends FileSelectorAction {
        ...
        private final FileSelector chooser;
        private final OpenMethod method;
    ...
    class PropertiesAction extends FileSelectorAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Window parent = SwingUtilities.getWindowAncestor((Component) selector);

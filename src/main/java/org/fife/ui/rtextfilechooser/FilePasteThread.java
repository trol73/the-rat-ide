...
final class FilePasteThread extends GUIWorkerThread<Object> {
     ...
     */
    private static class CannotCopyDialog extends EscapableDialog implements ActionListener {
     ...
     */
    private static class NameCollisionDialog extends JDialog implements ActionListener {
        ...
        private void init(File source, File dest) {
            ...
            doForAllCB = UIUtil.newCheckBox(MSG, "Dialog.NameCollision.RememberForFutureFiles");
            JPanel temp = new JPanel(new BorderLayout());
    ...
    private class NameCollisionResolver implements Runnable {
        ...
        public void run() {
            ...
            if (parent instanceof Frame) {
                ncd = new NameCollisionDialog((Frame) parent, file, dest);
            } else {
                ncd = new NameCollisionDialog((Dialog) parent, file, dest);
            }
            ncd.setVisible(true);

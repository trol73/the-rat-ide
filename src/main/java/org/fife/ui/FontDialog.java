...
public class FontDialog extends JDialog implements ActionListener, ListSelectionListener {
    ...
    private void init(Window owner, String title, Font initialSelection,
        ...
        float alignment = orientation.isLeftToRight() ? Component.LEFT_ALIGNMENT : Component.RIGHT_ALIGNMENT;
        ...
        if (initialSelection == null)
            initialSelection = owner != null ? owner.getFont() : new Font("Monospaced", Font.PLAIN, 13);

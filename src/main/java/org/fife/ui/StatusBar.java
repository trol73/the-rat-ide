...
public class StatusBar extends StatusBarPanel implements MouseListener {
    ...
    private final SizeGrip sizeGrip;
    ...
    public StatusBar(String defaultStatusMessage, int style) {
        ...
        c.weightx = 1.0;
        JPanel status = new StatusBarPanel(new GridLayout(1, 1, 8, 8), statusMessage);
    ...
    public void setStyle(int style) {
        ...
        if (oldStyle != style) {
            ...
            for (int i = 1; i < count; i++) {
                ((JComponent) comps[i]).setBorder(getStatusBarComponentBorder());
            }

...
public class DockableWindowPanel extends JPanel
        implements DockableWindowListener, PropertyChangeListener, DockableWindowConstants {

    public static final int LARGE_ON_SIDES = 0;
    public static final int LARGE_ON_TOP_AND_BOTTOM = 1;
    private final ContentPanel[] panels;
    private FloatingWindow[] floatingWindows;
    private final SortedSet<String> listeningTo;
    private int dockingStyle;
    protected List<DockableWindow> windowList;
    private final int[] panelToLocationMap = {0, 2, 1, 3,
                                              1, 3, 0, 2};
    ...
    public void setDockingStyle(int style) {
        if (dockingStyle != style && (style == LARGE_ON_SIDES || style == LARGE_ON_TOP_AND_BOTTOM)) {
            dockingStyle = style;
    ...
    final class ContentPanel extends JPanel {
        ...
        public int containsDockableWindow(DockableWindow window) {
            return windowPanel == null ? -1 : windowPanel.containsDockableWindow(window);
        }
        ...
        private class CollapsedPanel extends JPanel implements MouseListener {
            ...
            CollapsedPanel(int dockableWindowLocation) {
                ...
                add(toolbar, isHorizontal ? BorderLayout.LINE_END : BorderLayout.NORTH);
            ...
            private void maybeShowPopup(MouseEvent e) {
                if (e.isPopupTrigger()) {
                    ...
                    if (contextMenu == null) {
                        contextMenu = Actions.createRedockPopupMenu(DockableWindowPanel.this);
                    }

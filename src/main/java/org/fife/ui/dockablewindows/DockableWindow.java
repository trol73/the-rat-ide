...
public class DockableWindow extends JPanel {
     ...
     *
     * @param ensureExpanded Ensure the parent dockable window panel is expanded.
     */
    ...
    public String getDockableWindowTitle() {
        return dockableWindowTitle != null ? dockableWindowTitle : getDockableWindowName();
    }
    ...
    public void setPosition(int newPos) {
        if (newPos != position && isValidPosition(newPos)) {
            DockableWindowEvent e = new DockableWindowEvent(this, position, newPos);

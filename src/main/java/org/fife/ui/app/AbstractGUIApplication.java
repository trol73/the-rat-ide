...
public abstract class AbstractGUIApplication<P extends AppPrefs> extends JFrame
    ...
    private void initialize(AppContext<? extends AbstractGUIApplication<P>, P> context, String title, P prefs) {
        ...
        if (underscore > -1) {
            ...
            locale = new Locale(language.substring(0, underscore), language.substring(underscore + 1));
        } else {
        ...
        // actualContentPane contains the actual user content added via add().
    ...
    public ResourceBundle getResourceBundle() {
        if (resourceBundle == null) {
            resourceBundle = ResourceBundle.getBundle(getResourceBundleClassName());
        }
    ...
    public void setStatusBarVisible(boolean visible) {
        if (statusBar != null && statusBar.isVisible() != visible) {
            ...
            firePropertyChange(STATUS_BAR_VISIBLE_PROPERTY, !visible, visible);
        }
    }
    ...
    public void setToolBarVisible(boolean visible) {
        if (toolBar != null && toolBar.isVisible() != visible) {
            ...
            firePropertyChange(TOOL_BAR_VISIBLE_PROPERTY, !visible, visible);
        }
    }
     ...
     */
    public static class OptionsAction<T extends AbstractGUIApplication<?>> extends AppAction<T> {

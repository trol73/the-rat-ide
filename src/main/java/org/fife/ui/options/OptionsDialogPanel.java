...
public abstract class OptionsDialogPanel extends JPanel {
    ...
    /**
     * The name of this options panel to be used in the options dialog's
     * selection tree.
     */
    private String name;
     ...
     */
    private final List<OptionsDialogPanel> childPanels;
     ...
     *
     * @param parent The parent container.  This should have a vertical BoxLayout.
     ...
     * @param spacer The amount of vertical space to add after the component.
     *               This may be zero.
     * @param indent An amount to indent <code>toAdd</code> by.  This may be zero.
     * @see #addLeftAligned(Container, Component)
     * @see #addLeftAligned(Container, Component, int)
     */
    ...
    /**
     * Sets whether the "Unsaved changes" flag for this Options panel

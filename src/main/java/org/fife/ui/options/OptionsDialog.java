...
import org.fife.ui.widgets.LineDividerBorder;
import org.fife.ui.widgets.RScrollPane;
import org.fife.ui.widgets.TitledPanel;
...
public class OptionsDialog extends EscapableDialog implements ActionListener, TreeSelectionListener, PropertyChangeListener {
    ...
    private final JTree optionTree;
    private final DefaultTreeModel treeModel;
    private final DefaultMutableTreeNode root;
    private final JScrollPane optionTreeScrollPane;

    private final JButton okButton;
    private final JButton applyButton;
    private final JButton cancelButton;

    private final JPanel currentOptionPanel;
    private final CardLayout currentOptionPanelLayout;
    ...
    public OptionsDialog(Frame owner, OptionsDialogPanel[] optionsPanels) {
        ...
        optionTreeScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
    ...
    public final boolean doApply(Frame owner) {
        ...
        for (OptionsDialogPanel optionsPanel1 : optionsPanels) {
            OptionsDialogPanel.OptionsPanelCheckResult result = optionsPanel1.ensureValidInputs();
            if (result != null) {
...
//        UIUtil.expandAllNodes(optionTree);
     ...
     *
     * @param nameOrId The name or ID of the panel.  ID is preferred here, but either will work.
    ...
    private void setSelectedOptionsPanel(OptionsDialogPanel panel, boolean selectInTree) {
            ...
            for (int i = 0; i < optionTree.getRowCount(); i++) {
                ...
                if (node != null) {
                    ...
                    if (obj == panel) {
                        ...
                        SwingUtilities.invokeLater(() -> optionTree.scrollPathToVisible(path));
                        break;
                    }
                }
            }
        ...
        currentOptionPanelLayout.show(currentOptionPanel, createKeyForPanel(panel));

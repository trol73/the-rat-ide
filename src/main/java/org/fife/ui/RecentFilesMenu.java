...
public abstract class RecentFilesMenu extends JMenu {
     ...
     */
    private final List<String> fileHistory;
    ...
    public RecentFilesMenu(String name, String[] initialContents) {
        this(name, initialContents != null ? Arrays.asList(initialContents) : null);
    }
    ...
    public void addFileToFileHistory(String fileFullPath) {
        ...
        if (index > -1) {
            ...
            // to the top of that.
            JMenuItem menuItem = (JMenuItem) getMenuComponent(index);
            remove(index);
            insert(menuItem, 0);
        ...
        JMenuItem menuItem = new JMenuItem(createOpenAction(fileFullPath));
        insert(menuItem, 0);

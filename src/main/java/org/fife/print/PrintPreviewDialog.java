...
public class PrintPreviewDialog extends EscapableDialog implements ActionListener, ItemListener {
    ...
    private final JPanel previewPanel;        // The panel that actually shows the preview.
    private final PagePreview[] pageImage;    // Image of the page.
    private final Printable masterImage;        // The "master" (full-sized) image.

    private final JButton printButton;
    private final JButton nextPageButton;        // Button to view the next page.
    private final JButton prevPageButton;        // Button to view the previous page.
    private final JButton closeButton;

    private final JComboBox<String> sizeComboBox;        // To choose the preview's size.
    private final JComboBox<String> numPagesComboBox;    // To choose the number of pages to view at a time.
    ...
    private final PageFormat pageFormat;        // Used when generating a page.
    ...
    class PagePreview extends JPanel {
        ...
        PagePreview(int width, int height, BufferedImage source, Cursor cursorToUse) {
            sourceImage = source;
        ...
        public void setScaledSize(int width, int height) {
            this.width = width;
            this.height = height;
            drawImage = sourceImage.getScaledInstance(width, height, Image.SCALE_SMOOTH);//Image.SCALE_DEFAULT);
            repaint();
        }

 ...
 */
package org.fife.rtext.plugins.terminal;
 ...
 * @version 1.1
 */
class ConsoleOptionPanel extends AbstractConsoleTextAreaOptionPanel<Plugin> implements ActionListener {
	...
	protected void setValuesImpl(Frame owner) {
		...
		cbStdout.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_STDOUT));
		stdoutButton.setEnabled(window.isStyleUsed(ConsoleTextArea.STYLE_STDOUT));
		cbStderr.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_STDERR));
		stderrButton.setEnabled(window.isStyleUsed(ConsoleTextArea.STYLE_STDERR));
		cbPrompt.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_PROMPT));
		promptButton.setEnabled(window.isStyleUsed(ConsoleTextArea.STYLE_PROMPT));
		cbExceptions.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_EXCEPTION));

...
public class Plugin extends GUIPlugin<RText> {
    ...
    private static final String MSG_BUNDLE = "org.fife.rtext.plugins.terminal.Plugin";
    ...
    private static File getPrefsFile() {
        return new File(RTextUtilities.getPreferencesDirectory(), "terminal.properties");
    }
    ...
    private void loadIcons() {
        icons = new HashMap<>();
        try {
            icons.put(NativeTheme.ID, new ImageIcon(getClass().getResource("eclipse/terminal.png")));

            Image darkThemeImage = ImageTranscodingUtil.rasterize("console dark",
                    getClass().getResourceAsStream("flat-dark/terminal.svg"), 16, 16);
            ...
            Image lightThemeImage = ImageTranscodingUtil.rasterize("console light",
                    getClass().getResourceAsStream("flat-light/terminal.svg"), 16, 16);

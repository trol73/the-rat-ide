 ...
 * @version 1.0
 */
public class FileTreeNode extends AbstractWorkspaceTreeNode implements PhysicalLocationTreeNode {
    ...
    public static class FileNameChecker implements NameChecker {
        ...
        public String isValid(String text) {
            ...
            if (text.endsWith(".")) {
                return folder ? "folderNameCannotEndWithDot" : "fileNameCannotEndWithDot";
            }
            if (parentDir != null) {

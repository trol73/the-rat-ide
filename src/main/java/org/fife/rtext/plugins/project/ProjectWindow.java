...
class ProjectWindow extends DockableWindow {
    ...
    private JToolBar createToolBar(ProjectPluginPrefs prefs) {
        ...
        mb.addSeparator();
        mb.addMenuItem(new JCheckBoxMenuItem(new ShowWorkspaceTreeNodeAction(prefs.treeRootVisible)));
        mb.addSeparator();
    ...
    private abstract class AbstractWorkspaceAction extends BaseAction {
        ...
        boolean saveWorkspace(Workspace workspace) {
            ...
            try {
                ...
                String msg = Messages.getString("NewWorkspaceDialog.ErrorSavingWorkspace.ConfirmDiscard");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (newName != null) {
                ...
                try {
                    ...
                    String msg = Messages.getString("NewWorkspaceDialog.ErrorCreatingNewWorkspace");

...
public class ProjectPlugin extends GUIPlugin<RText> {
    ...
    private static File getPrefsFile() {
        return new File(RTextUtilities.getPreferencesDirectory(), "projects.properties");
    }
     ...
     */
    private void insertTreeNodeInto(final MutableTreeNode child, MutableTreeNode parent, int index) {
    ...
    public void savePreferences() {
        ...
        prefs.openWorkspaceName = workspace == null ? null : workspace.getFileFullPath();
        prefs.treeRootVisible = getTree().isRootVisible();

        File prefsFile = getPrefsFile();
        try {
            prefs.save(prefsFile);
            new WorkspaceTreeStateSaver().saveState(getTree());
        } catch (IOException ioe) {

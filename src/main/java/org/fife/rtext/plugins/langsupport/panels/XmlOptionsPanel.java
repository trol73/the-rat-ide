 ...
 * @version 1.0
 */
public class XmlOptionsPanel extends OptionsDialogPanel implements ActionListener {
     ...
     */
    public XmlOptionsPanel(RText app) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (autoCompleteClosingTagsCB == source || codeCompletionEnabledCB == source || foldingEnabledCB == source) {
            setDirty(true);

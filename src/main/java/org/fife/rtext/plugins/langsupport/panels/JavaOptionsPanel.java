 ...
 * @version 1.0
 */
public class JavaOptionsPanel extends OptionsDialogPanel {
     ...
     */
    public JavaOptionsPanel(RText app) {
        ...
        String[] colNames = {msg.getString("Options.Java.JarFile"), msg.getString("Options.Java.SourceLocation")};
        ModifiableTable bpt = new ModifiableTable(model, colNames, ModifiableTable.BOTTOM, ModifiableTable.ADD_REMOVE_MODIFY);
        bpt.addModifiableTableListener(listener);
        bpt.getTable().setPreferredScrollableViewportSize(new Dimension(50, 16 * 8));
        ...
        addChildPanel(new FoldingOnlyOptionsPanel(app, SyntaxConstants.SYNTAX_STYLE_JAVA, false));
    ...
    private static final class RowHandlerDialog extends EscapableDialog implements ActionListener {
        ...
        private RowHandlerDialog(JDialog parent, Object[] old) {
            ...
            if (getComponentOrientation().isLeftToRight()) {
                topPanel.add(jarLabel);
                topPanel.add(jarField);

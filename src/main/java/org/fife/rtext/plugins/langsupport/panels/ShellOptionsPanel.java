 ...
 * @version 1.0
 */
public class ShellOptionsPanel extends OptionsDialogPanel {
     ...
     */
    public ShellOptionsPanel(RText app) {
    ...
    protected void doApplyImpl(Frame owner) {
        ...
        LanguageSupport ls = lsf.getSupportFor(SyntaxConstants.SYNTAX_STYLE_UNIX_SHELL);

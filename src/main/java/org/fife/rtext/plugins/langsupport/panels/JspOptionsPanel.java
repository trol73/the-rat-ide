...
public class JspOptionsPanel extends OptionsDialogPanel {
     ...
     */
    public JspOptionsPanel(RText app) {
    ...
    protected void doApplyImpl(Frame owner) {
        ...
        JspLanguageSupport ls = (JspLanguageSupport) lsf.getSupportFor(SyntaxConstants.SYNTAX_STYLE_JSP);
    ...
    private class Listener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (enabledCB == source) {
                ...
                if (!enabledCB.isSelected() || !autoAddClosingTagsCB.isSelected() || !foldingEnabledCB.isSelected()) {

...
public class RTextPrefs extends AppPrefs implements RTextActionInfo {
    ...
    public void setDefaults() {
        ...
        userDictionary = new File(RTextUtilities.getPreferencesDirectory(),"userDictionary.txt");
        ...
        searchWindowOpacityRule = ChildWindowListener.TRANSLUCENT_WHEN_OVERLAPPING_APP;

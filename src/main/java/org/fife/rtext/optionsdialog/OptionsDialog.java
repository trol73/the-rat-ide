 ...
 * @version 1.0
 */
public class OptionsDialog extends org.fife.ui.options.OptionsDialog {

    private final RText rtext;
    private final OptionsDialogPanel generalPanel;
    private final OptionsDialogPanel uiPanel;
    private final OptionsDialogPanel languagePanel;
    private final OptionsDialogPanel rtaPanel;
    private final OptionsDialogPanel searchPanel;
    private final OptionsDialogPanel fileChooserPanel;
    private final OptionsDialogPanel filtersPanel;
    private final OptionsDialogPanel shortcutPanel;

 ...
 * @version 0.5
 */
class LanguageOptionPanel extends OptionsDialogPanel implements ListSelectionListener {
    ...
    private String getSelectedLanguage() {
        ...
        if (code == null) {
            app.displayException(
                    new InternalError("Couldn't find language code for language: " + language));
            code = "en";
        }
        return code;
    }

...
public class RemoteFileChooser extends EscapableDialog
    ...
    private final JLabel protoLabel;
    ...
    public RemoteFileChooser(RText owner) {
        ...
        advancedButton.setMnemonic((int) msg.getString("AdvancedMnemonic").charAt(0));
